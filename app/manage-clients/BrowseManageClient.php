...
$_SESSION["page"] = "BrowseManageClient";
?>
<!DOCTYPE html>
            ...
            <div class="col-md-12 content">
                ...
                <div class="row search-add-row">
                    <div class="col-md-2 offset-md-4">
                        <a class="btn btn-primary" href="AddClient.php" role="button">New Client</a>
                    </div>
                </div>
                <!-- Properties table -->
                            ...
                            <div class="modal-dialog modal-sm">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" id="gridModalLabel">Delete Client</h4>
                                    </div>
                                    <form method="post" Action="ManageClientDelete.php">
