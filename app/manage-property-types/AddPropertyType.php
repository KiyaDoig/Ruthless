                ...
                <div class="col-md-12 content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form id="prop-form" data-toggle="validator" method="post" Action="ManagePropertyTypeCreate.php">

                                <div class="form-group street row">
                                    <label for="type-name-input" class="col-xs-2 col-form-label">Type Name</label>
                                    <div class="col-xs-10">
                                        <input name="typeName" class="form-control" type="text" id="type-name-input" required>
                                    </div>
                                </div>
